...
int regs[regCount] = {0};
unsigned int pc = 0x0;
const unsigned int RAM = 2 * 10485760; // 2 * 10 MB
char memory[RAM];
...
void instDecExec(unsigned int instWord)
{
    ...
    switch(opcode)
    {
        ...
        case 0x13:  // Immediate Instructions
        case 0x33:  // Register Instructions
            cout << "RF[" << std::setw(2) << rd << "]=" << hex << std::setfill('0') << std::setw(8) << regs[rd] << endl;
            break;
        default: break;
    }
    setZero();
...
void SB(unsigned int rs2, unsigned int rs1, unsigned int offset, unsigned int address)
{
    ...
    cout << "Mem: write 0x" << setfill('0') << setw(8) << std::hex << regs[rs2];
    cout << " to 0x" << setfill('0') << setw(8) << std::hex << address << " (0)"  << endl;
...
void SH(unsigned int rs2, unsigned int rs1, unsigned int offset, unsigned int address)
{
    ...
    if(address%2) cout << "Memory address not divisible by 2 -- " << address << endl;
    cout << "Mem: write 0x" << setfill('0') << setw(8) << std::hex << regs[rs2];
    cout << " to 0x" << setfill('0') << setw(8) << std::hex << address << " (1)"  << endl;
...
void SW(unsigned int rs2, unsigned int rs1, unsigned int offset, unsigned int address)
{
    ...
    if(address%4) cout << "Memory address not divisible by 4 -- " << address << endl;
    cout << "Mem: write 0x" << setfill('0') << setw(8) << std::hex << regs[rs2];
    cout << " to 0x" << setfill('0') << setw(8) << std::hex << address << " (2)"  << endl;
